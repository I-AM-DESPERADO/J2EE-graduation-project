...
<html lang="en">
			...
			<div class="main-content">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active" targeturl='${pageContext.request.contextPath}/workflow/check/index'>工时统计</li>
						</ul>
					</div>
								...
								<div class="page-header page-header-revise">
									<form role="form" class="form-inline">
										<div class="form-group">
												...
												上班日期起
												<input type="text"  id="datefrom" 	placeholder="上班日期起" class="form-control form_datetime ">
												上班日期止
												<input type="text" id="dateend" 	placeholder="上班日期止" class="form-control form_datetime" >
    ...
    $(document).ready(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
	            ...
	            "ajax": {
	                "url":  $.common.getContextPath() + "/workflow/check/listall",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
				 ...
				 "columnDefs": [
				                { "render": function ( data, type, row ) {
				                        	return  "<span class='label label-primary'>"+data+"天</span>";
				                        	},
				                    "targets":2
				                },
				                { "render": function ( data, type, row ) {
    ...
    $(document).ready(function(){
    	...
    	$(".submenu a[href='${pageContext.request.contextPath}/workflow/check/index']").parent().addClass("active");
    });
    </script>
    	</body>
</html>
