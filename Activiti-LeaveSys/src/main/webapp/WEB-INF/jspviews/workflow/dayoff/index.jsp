...
<html lang="en">
			...
			<div class="main-content">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active" targeturl='${pageContext.request.contextPath}/workflow/dayoff/index'>请假单查询</li>
						</ul>
					</div>
								...
								<div class="page-header page-header-revise">
									<form role="form" class="form-inline">
										<div class="form-group">
											部门
												<select name='deptment.id'  id='deptment' class=" form-control">
												...
												请假日期起
												<input type="text"  id="datefrom" 	placeholder="请假日期起" class="form-control form_datetime ">
												请假日期止
												<input type="text" id="dateend" 	placeholder="请假日期止" class="form-control form_datetime" >
    ...
    $(document).ready(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
	            ...
	            "ajax": {
	                "url":  $.common.getContextPath() + "/workflow/dayoff/listall",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
    ...
    $(document).ready(function(){
    	...
    	$(".submenu a[href='${pageContext.request.contextPath}/workflow/dayoff/index']").parent().addClass("active");
    });
    </script>
    	</body>
</html>
