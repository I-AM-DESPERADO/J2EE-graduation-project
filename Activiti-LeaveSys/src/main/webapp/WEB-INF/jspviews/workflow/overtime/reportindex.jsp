...
<html lang="en">
			...
			<div class="main-content">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active" targeturl='${pageContext.request.contextPath}/workflow/overtime/reportindex'>加班统计</li>
						</ul>
					</div>
    ...
    $(document).ready(function(){
        	...
        	table=$('#dt_table_view').DataTable( {
	            ...
	            "ajax": {
	                "url":  $.common.getContextPath() + "/workflow/overtime/report",
	                "type": "POST",
	                "dataSrc": "datas"
	              },
				"columns" : [{
    ...
    $(document).ready(function(){
    	...
    	$(".submenu a[href='${pageContext.request.contextPath}/workflow/overtime/reportindex]").parent().addClass("active");
    });
    </script>
    	</body>
</html>
