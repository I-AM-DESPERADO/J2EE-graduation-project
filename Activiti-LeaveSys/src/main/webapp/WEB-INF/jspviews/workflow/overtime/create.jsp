		                           	...
		                           	<table class='table table-bordered'>
		                           		...
		                           		<tbody>
		                           		  ...
		                           		  <tr>
		                           				...
		                           				<td>姓名：</td>
		                           				<td><input id='chinesename' required="required" name='chinesename' type="text" value="${sessionScope.currentUser.chinesename}" class="form-control" ></td>
		                           			</tr>
		                           			
		                           			 
		                           		  <tr>
		                           				<td>工号：</td>
		                           				<td><input id='username' required="required" name='username' type="text" value="${sessionScope.currentUser.username}" class="form-control" ></td>
		                           				<td>电话：</td>
		                           			...
		                           			<tr>
		                           				<td>共计小时：</td>
		                           				<td colspan="3" ><input  id='hours' name='hours' type="text" class="form-control input-group date" onclick="delta_t()" ></td>
